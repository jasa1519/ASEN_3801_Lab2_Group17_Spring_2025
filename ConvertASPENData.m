...
% ConvertASPENData
% Created: 9/21/23
function [pos_av_class, att_av_class, pos_tar_class, att_tar_class] =
...
% att_av_aspen = 3 x n array of attitude vectors using the 'helical
angles'
% provided by the ASPEN motion capture system
% pos_tar_aspen = 3 x n array of position vectors in coordinate
% system of the ASPEN motion capture system
% att_tar_aspen = 3 x n array of attitude vectors using the 'helical
angles'
% provided by the ASPEN motion capture system
%
%
...
%
%
% Methodology: Converts the data provided by the ASPEN lab motion capture system
into
...
% https://academicflight.com/articles/kinematics/rotation-formalisms/euler-
angles/
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
pos_av_class(:,i) = [pos_av_aspen(1,i); -pos_av_aspen(2,i); -
pos_av_aspen(3,i)];
xfm_av =
makehgtform('xrotate',att_av_aspen(1,i),'yrotate',att_av_aspen(2,i),'zrotate',att_a
v_aspen(3,i));
...
pos_tar_class(:,i) = [pos_tar_aspen(1,i); -pos_tar_aspen(2,i); -
pos_tar_aspen(3,i)];
xfm_tar =
makehgtform('xrotate',att_tar_aspen(1,i),'yrotate',att_tar_aspen(2,i),'zrotate',att
_tar_aspen(3,i));
